...
>	3.	Representar y unir los puntos para obtener una **recta**:  
	!["Recta"](http://www.vitutor.org/ecuaciones/ine/images/28_0.gif)  
>	4.	Tomar dos puntos y los sustituirlos en la desigualdad. Si se cumple, la solución es el semiplano donde se encuentra el punto; si no la solución será el otro semiplano.  
	*	`2x + y ≤ 3`  
		`2 · 0 + 0 ≤ 3`  
		`0 ≤ 3` **Sí**  
		!["Es solución"](http://www.vitutor.org/ecuaciones/ine/images/28.gif)
	*	`2x + y ≤ 3`  
		`2 · 2 + 3 ≤ 3`  
		`7 ≤ 3` **No**  
		!["no es solución"](http://www.vitutor.org/ecuaciones/ine/images/29.gif)  
...
> 2.  Obtener las raíces de la ecuación de segundo grado:  
  !["Raíces de la ecuación"](http://www.vitutor.org/ecuaciones/ine/images/24.gif)  
  Raíces:
  `4`
  y
  `2`
> 3.  Representar las raíces en la recta real y dividirla en los intervalos posibles:  
  !["Recta real"](http://www.vitutor.org/ecuaciones/ine/images/25_0.gif)  
...
> 5.  Los intervalos solución son los que cumplen que la inecuación mediante el signo evaluado:  
  !["Solución"](http://www.vitutor.org/ecuaciones/ine/images/25.gif)  
  *Sol:* **`(-∞, 2)`⋃`(4, +∞)`**  
...
!["Inecuación"](http://www.vitutor.org/ecuaciones/ine/images/33.gif)  
...
> 2.  Representar las raíces en la Recta Real *(las del denominador deben ser abiertas)*:  
  !["Recta Real"](http://www.vitutor.org/ecuaciones/ine/images/25_0.gif)  
  !["Denominador abierto"](http://www.vitutor.org/ecuaciones/ine/images/35.gif)  
> 3.  Tomar un punto de cada intervalo para evaluarlos:  
  !["Evaluar inetrvalo 1"](http://www.vitutor.org/ecuaciones/ine/images/36.gif) ⇒ **`+`**  
  !["Evaluar inetrvalo 2"](http://www.vitutor.org/ecuaciones/ine/images/37.gif) ⇒ **`-`**  
  !["Evaluar inetrvalo 3"](http://www.vitutor.org/ecuaciones/ine/images/38.gif) ⇒ **`+`**  
  !["Intervalos evaluados"](http://www.vitutor.org/ecuaciones/ine/images/34.gif)  
> 4.  La solución está compuesta por los intervalos que cumplen la inecuación mediante su signo:  
  *Sol:* **`(-∞, 2]`⋃`(4, ∞)`**
  
### Ejemplo:
> Inecuación:  
  !["Inecuación"](http://www.vitutor.org/ecuaciones/ine/images/44.gif)  
  Dejamos `0` en el segundo miembro pasando el `2` al primero y reducimos la expresión:  
  !["Hacer que un miembro sea 0"](http://www.vitutor.org/ecuaciones/ine/images/45.gif)  
  Hallamos las raíces del numerador:  
  `−x + 7 = 0`⇒`x = 7` ⇒ `7`  
  `x − 2 = 0` ⇒ `x = 2` ⇒ `2`  
  Evaluamos el signo:  
  !["Evaluar signo"](http://www.vitutor.org/ecuaciones/ine/images/46.gif)  
  !["Evaluar signo"](http://www.vitutor.org/ecuaciones/ine/images/47.gif)  
  !["Evaluar signo"](http://www.vitutor.org/ecuaciones/ine/images/48.gif)  
  Los intervalos solución son los que cumplen que la inecuación mediante el signo evaluado:  
  !["Evaluar signo"](http://www.vitutor.org/ecuaciones/ine/images/49.gif)  
  *Sol:* **`(-∞, 2)`⋃`(7, ∞)`**  
...
![](http://www.vitutor.org/ecuaciones/ine/images/15.gif)  
> 1.  Resolver cada inecuación de forma **independiente**:  
![](http://www.vitutor.org/ecuaciones/ine/images/16.gif)  
![](http://www.vitutor.org/ecuaciones/ine/images/17.gif)  
...
![](http://www.vitutor.org/ecuaciones/ine/images/19.gif)  
*Sol:* **`[−1, 3]`**  
...
![](http://www.vitutor.org/ecuaciones/ine/images/30.gif)  
> 1.  Resolver la primera inecuación de forma **individual**:  
	...
	*	Representar y unir estos puntos para obtener una recta:  
	![](http://www.vitutor.org/ecuaciones/ine/images/28_0.gif)  
...
2.  Resolver la segunda inecuación de forma **individual**:  
	...
	**`(1, 0)`**  
	*	Representar y unir estos puntos para obtener una recta:  
	![](http://www.vitutor.org/ecuaciones/ine/images/31_0.gif)  
	*	Tomar un punto y sustituirlo en la desigualdad. Si se cumple, la solución es el semiplano donde se encuentra el punto, si no la solución será el otro semiplano:  
	`x + y ≥ 1`  
	`0 + 0 ≥ 1`  
	**`0 ≥ 1`** → **No**  
